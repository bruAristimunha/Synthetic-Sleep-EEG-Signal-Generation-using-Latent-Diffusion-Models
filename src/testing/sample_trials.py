...
def parse_args():
    ...
    parser.add_argument("--best_model_path",
                        ...
                        default="/project/outputs/aekl_eeg_{}_{}_double_sleep_edfx")
    ...
    parser.add_argument("--diffusion_path", help="Path to the .pth model from the diffusion model.",
                        ...
                        default="/project/outputs/ldm_double/ldm_eeg_{}_{}_double_sleep_edfx")
...
def main(args):
    ...
    output_dir = Path(args.output_dir + "/samples_ldm_{}_{}_".format(args.latent_channels, args.spe))
    output_dir.mkdir(exist_ok=True, parents=True)

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    print(f"Using device: {device}")

    config_aekl = OmegaConf.load(args.autoencoderkl_config_file_path.format(args.spe, args.latent_channels))
    ...
    #train_loader = test_dataloader(config=config_aekl, args=args)
    ...
    diffusion_path = args.diffusion_path.format(args.spe, args.latent_channels)
