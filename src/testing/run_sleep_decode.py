...
def parse_args():
    ...
    parser.add_argument(
        "--config_file",
        type=str,
        default=f"{base_path}/config/config_sleep_stage.yaml",
...
def main(args):
    ...
    valid_sampler = SequenceSampler(valid_set.get_metadata(), n_windows,
                                    n_windows_stride)

    test_sampler = SequenceSampler(test_set.get_metadata(), n_windows,
                                   n_windows_stride)
    # Print number of examples per class
    print('Training examples: ', len(train_sampler))
    print('Validation examples: ', len(valid_sampler))
    print('Test examples: ', len(test_sampler))
    ...
    check_point = Checkpoint(dirname=run_dir/ "checkpoint" )
